...
- (id)initWithStyle:(HZAreaPickerStyle)pickerStyle delegate:(id<HZAreaPickerDelegate>)delegate
{
    ...
    if (self) {
        ...
        //self.locatePicker = [[UIPickerView alloc]initWithFrame:CGRectMake(50, 200, 320, 200)];
        
        self.locatePicker.dataSource = self;
        self.locatePicker.delegate = self;
        blackView = [[UIView alloc]initWithFrame:self.superview.bounds];
...
- (void)showInView:(UIView *) view
{
    ...
    //self.center = CGPointMake(view.center.x, view.frame.size.height+self.frame.size.height/2);
